        ...
        <div className='products'>
            ...
            <div className='products1'>
                <div className='productContainer'>
                    <img  className='productimage' src={product1} alt="" />
                ...
                <div className='productContainer'>
                    <img className='productimage' src={product2} alt="" />
            ...
            <div className='products2'>
                <div className='productContainer'>
                    <img className='productimage' src={product3} alt="" />
                ...
                <div className='productContainer'>
                    <img className='productimage' src={product4} alt="" />
                    <p>
